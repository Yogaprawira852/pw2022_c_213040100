...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <hr>
      <h3 align="center" class="text-dark">Admin</h3>
      <hr><br>
      <a href="../index.php"><button class="button">Kembali</button></a>
      <a href="?page=add"><button class="btn-info">Add Article</button></a>
      ...
      <div>
        ...
        <div align="justify">
          ...
          <a href="edit.php?id=<?php echo $data["id"] ?>"><button class="button">Edit Article</button></a><br>
        </div>
