...
function koneksi() {
    $conn = mysqli_connect('localhost', 'root', '', 'pw2022_c_213040100') or die('KONEKSI GAGAL!');
...
function hapus($id) {
    ...
    // query mahasiswa berdasarkan sesuai id
...
function upload() {
    ...
    // cek apakah file yang di puload bukan gambar
