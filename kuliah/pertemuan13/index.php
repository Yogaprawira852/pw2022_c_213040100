                ...
                <?php $i=1; foreach ($mahasiswa as $mhs) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="hapus.php?id=<?= $mhs{"id"};?>" class= "btn badge bg-danger" onclick=" return confirm('yakin?'); class="btn badge bg-danger">Delete</a>
                            <a href="edit.php?id=<?= $mhs{"id"};?>" class= "btn badge bg-danger" onclick=" return confirm('yakin?'); class="btn badge bg-danger">Edit</a>
